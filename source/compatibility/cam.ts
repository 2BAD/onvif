...
import { Onvif, OnvifRequestOptions, SetSystemDateAndTimeOptions } from '../onvif.ts'
...
export class Cam extends EventEmitter {
  ...
  getCapabilities(callback: Callback) {
    this.onvif.device
      .getCapabilities()
      .then((result) => callback(null, result.capabilities))
      .catch(callback)
  }
  ...
  getVideoSources(callback: Callback) {
    this.onvif.media
      .getVideoSources()
      .then((result) => callback(null, result.videoSources))
      .catch(callback)
  }
  ...
  getVideoSourceConfigurations(callback: Callback) {
    this.onvif.media
      ...
      .then((result) => callback(null, result.configurations))
      .catch(callback)
  }
  ...
  getServices(includeCapability: boolean | Callback, callback: Callback) {
    if (callback) {
      this.onvif.device
        ...
        .then((result) => callback(null, result.service))
        .catch(callback)
    } else {
      this.onvif.device
        .getServices()
        .then((result) => (includeCapability as Callback)(null, result.service))
        .catch(callback)
    }
  }
  ...
  getStreamUri(options: GetStreamUriOptions | Callback, callback?: Callback) {
    ...
    this.onvif.media
      .getStreamUri()
      .then((result) => (options as Callback)(null, result))
